...
class PipelineResult(BaseParserResult):
    ...
    def __init__(
        ...
        Args:
            ...
            reviewed_raw_json_result: LLM-corrected model output (optional).
            model_review_report: LLM review metadata dict (optional).
        """
        super().__init__(
            ...
            reviewed_raw_json_result=reviewed_raw_json_result,
